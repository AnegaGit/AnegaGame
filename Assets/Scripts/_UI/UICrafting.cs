        ...
        if (player)
        {
            ...
            if (panel.activeSelf)
            {
                ...
                if (recipe != null)
                {
                    ...
                    resultSlotToolTip.text = item.ToolTip();
                    ...
                    progressSlider.gameObject.SetActive(player.state == GlobalVar.stateCrafting);
                ...
                craftButton.interactable = recipe != null &&
                                           player.state != GlobalVar.stateCrafting &&
                                           player.craftingState != CraftingState.InProgress &&
                                           player.InventoryCanAdd(new Item(recipe.result), 1,player.ContainerIdOfBackpack());
